...
const codeLines = [
  { color: '#00d4ff', text: 'const saif = {'   },
  { color: '#f0abfc', text: '  role: "Dev",'   },
  { color: '#00ff9f', text: '  stack: React,'  },
  { color: '#f0abfc', text: '  passion: ∞'     },
  { color: '#00d4ff', text: '}'                },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className={`font-syne text-5xl sm:text-6xl lg:text-7xl font-bold leading-none mb-4 ${
            ...
            >
              ...
              <span className="font-mono text-lg text-cyber-cyan typing-cursor">
                {typedText}
              </span>
            </motion.div>
            ...
            >
              Specializing in{' '}
              <span className="text-cyber-cyan font-medium">React.js</span> and modern
              JavaScript. I build scalable, high-performance web applications with clean
            ...
            >
              ...
              <span className={`font-mono text-xs ${isDark ? 'text-gray-600' : 'text-gray-400'}`}>
                @saif-ali6600
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <div
                className="w-full h-full rounded-3xl overflow-hidden border border-cyber-border"
                style={{
                  background: 'linear-gradient(135deg, #0d0d22, #1a0a2e)',
                  boxShadow:
                    '0 0 60px rgba(0,212,255,0.12), 0 0 100px rgba(124,58,237,0.08)',
                }}
              >
        ...
        >
          {stats.map(({ value, label }) => (
            <div key={label} className="text-center">
              ...
              <div className={`font-outfit text-xs mt-1 ${isDark ? 'text-gray-500' : 'text-gray-500'}`}>
                {label}
              </div>
            </div>
          ))}
